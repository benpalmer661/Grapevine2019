//
//  ProfileHeaderClosed.swift
//  Grapevine2019
//
//  Created by Ben Palmer on 28/3/18.
...
//
//we need to make a ProfileHeaderClosed for the profile header pages to switch between view etc


protocol ProfileHeaderClosedDelegate {
...
class ProfileHeaderClosed: UICollectionViewCell {
    
    var delegate: ProfileHeaderClosedDelegate?
