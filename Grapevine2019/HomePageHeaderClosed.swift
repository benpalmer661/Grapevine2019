//
//  HomePageHeaderClosed.swift
//  Grapevine2019
//
//  Created by Ben Palmer on 25/3/18.
...
protocol HomePageHeaderClosedDelegate {
...
class HomePageHeaderClosed: UICollectionViewCell {
    
    var delegate: HomePageHeaderClosedDelegate?
