...
class PRP2Username: UIViewController, UITextFieldDelegate {
            ...
            docRef.getDocument { (document, error) in
                if let document = document {
                    ...
                    if document.exists{
                        ...
                        db.collection("Users").document(uid).setData([ "Username" : username, "Subtitle" : username, "Display Name": username, "Persons Account": true, "UID": uid, "All Users & Services": true, "Online & Offline": true, "All Genders": true,"All Account Types": true, "Account Type": "Persons","Online Offline Status": "Offline"], options: SetOptions.merge())
    ...
    func setupViews(){
        ...
        personsIconImageView.anchor(top: containerView.topAnchor, left: nil, bottom: nil, right: nil, paddingTop: 70, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 60, height: 60)
        ...
        personsAccountLabel.anchor(top: personsIconImageView.bottomAnchor, left: nil, bottom: nil, right: nil, paddingTop: 20, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 200, height: 30)
        ...
        usernameTextField.anchor(top: personsAccountLabel.bottomAnchor, left: nil, bottom: nil, right: nil, paddingTop: 80, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 220, height: 30)
