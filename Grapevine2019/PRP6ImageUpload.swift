...
class PRP6ImageUpload: UIViewController,UINavigationControllerDelegate, UIImagePickerControllerDelegate {
...
//                    self.registerUserIntoDatabaseWithUID(userId!, values: values as [String : AnyObject])
    ...
    func submitButtonADD(){
        ...
        if let uploadData = UIImagePNGRepresentation(UIImage(named:"P icon-72x72")!) {
    ...
    func setupViews(){
        ...
        uploadProfileImageDescriptionLabel.anchor(top: uploadProfileImageButton.bottomAnchor, left: nil, bottom: nil, right: nil, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 200, height: 25)
